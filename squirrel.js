var JOURNAL = [
  ...
  {
    'events': [
      'brussel sprouts', 'ice cream', 'brushed teeth', 'computer', 'weekend'
    ],
    'squirrel': false
  },
  {
    'events': [
      'potatoes', 'candy', 'brushed teeth', 'exercise', 'weekend', 'dentist'
    ],
    'squirrel': false
  },
  {
    'events':
        ['brussel sprouts', 'pudding', 'brushed teeth', 'running', 'weekend'],
    'squirrel': false
  },
  {
  ...
  {
    'events': [
      'cauliflower', 'peanuts', 'brushed teeth', 'computer', 'work',
      'touched tree'
    ],
    'squirrel': false
  },
  ...
  {
    'events':
        ['carrot', 'brushed teeth', 'exercise', 'weekend', 'touched tree'],
    'squirrel': false
  },
...
for (let event of jounralEvents(JOURNAL)) {
  ...
  if (correlation > 0.1 || correlation < -0.1) {
    console.log(event + ':' + phi(tabbleFor(event, JOURNAL)));
  }
}
